    ...
    <section className="relative -mt-8 w-full overflow-hidden pb-12 pt-[4.25rem] md:-mt-12 md:pb-16 md:pt-[5.25rem] lg:flex lg:min-h-[86svh] lg:items-center lg:pb-20 lg:pt-24">
      ...
      <div className="home-container relative">
        <motion.div
          ...
          className="grid gap-8 pb-9 md:pb-11 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,0.9fr)] lg:items-center lg:gap-20"
        >
          <div>
          ...
          <div className="max-w-2xl lg:justify-self-start">
            ...
            <Link
              href="/about"
              className="group mt-7 inline-flex items-center gap-3 rounded-full border border-[#C2A139]/50 bg-[#242124]/72 px-6 py-4 text-[11px] font-bold uppercase tracking-[0.22em] text-[#F5F0E8] shadow-[0_18px_55px_rgba(0,0,0,0.28)] backdrop-blur-md transition-all duration-300 hover:-translate-y-0.5 hover:border-[#C2A139] hover:bg-[#C2A139] hover:text-[#242124] hover:shadow-[0_24px_75px_rgba(194,161,57,0.2)]"
            >
              About TMS Estates
        ...
        >
          {pillars.map((item) => (
            <article
              key={item.title}
              className="group relative min-h-[172px] overflow-hidden border border-transparent bg-[#242124] p-6 shadow-[0_24px_80px_rgba(0,0,0,0.42)] backdrop-blur-[8px] transition-all duration-300 hover:-translate-y-1 hover:border-[#C2A139]/70 hover:shadow-[0_30px_95px_rgba(0,0,0,0.5)] md:p-7"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-[#F5F0E8]/[0.04] via-[#242124] to-[#05070B]/56" />
