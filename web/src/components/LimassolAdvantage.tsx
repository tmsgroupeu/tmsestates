  ...
  return (
    <section className="relative w-full overflow-hidden py-12 md:py-14 lg:py-16">
      <div className="home-container">
        <div className="overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,0.32)]">
          <div className="relative bg-[#242124] px-6 py-8 md:px-8 md:py-10 lg:px-10 lg:py-11">
            ...
            <div className="relative z-10 grid gap-8 lg:grid-cols-[0.82fr_1.18fr] lg:items-end">
              ...
              <div className="max-w-2xl lg:justify-self-end">
                <p className="text-[0.98rem] leading-8 text-[#F5F0E8]/84 md:text-[1.04rem] md:leading-8">
          ...
          <div className="grid bg-[#242124]/58 md:grid-cols-3">
            {points.map((point, index) => (
              <article
                key={point}
                className="investment-point-card group relative min-h-[145px] overflow-hidden border-b border-[#F5F0E8]/10 bg-[#242124]/74 p-6 backdrop-blur-[5px] transition-all duration-500 hover:bg-[#242124]/90 md:border-b-0 md:border-r md:last:border-r-0 lg:min-h-[158px] lg:p-7 xl:p-8"
              >
