...
export default function LimassolAdvantage() {
  return (
    <section className="relative w-full pt-0 pb-14 md:pb-18 lg:flex lg:min-h-[88svh] lg:items-center">
      <div className="home-container">
        <div className="relative overflow-hidden shadow-[0_42px_150px_rgba(0,0,0,0.34)]">
          <div className="relative grid lg:grid-cols-[1fr_1.12fr]">
            <div className="relative p-5 md:p-7 lg:p-8 xl:p-9">
              <div className="relative max-w-[720px] overflow-hidden bg-[#242124]/46 px-6 py-8 shadow-[0_24px_85px_rgba(0,0,0,0.24)] backdrop-blur-[3px] md:px-8 md:py-10 lg:px-9 lg:py-11">
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#242124]/36 via-[#242124]/10 to-[#C2A139]/8" />
            ...
            <div className="relative bg-[#242124]/96 shadow-[0_34px_110px_rgba(0,0,0,0.36)]">
              <div className="relative grid md:grid-cols-3 lg:grid-cols-1">
                {points.map((point, index) => (
                  <div
                    key={point}
                    className="group relative flex min-h-[150px] items-start gap-5 overflow-hidden border-b border-[#F5F0E8]/10 bg-[#242124]/64 p-6 last:border-b-0 transition-all duration-300 hover:bg-[#242124]/78 md:min-h-[220px] md:border-b-0 md:border-r md:last:border-r-0 lg:min-h-[150px] lg:border-b lg:border-r-0 lg:p-8 xl:p-9"
                  >
