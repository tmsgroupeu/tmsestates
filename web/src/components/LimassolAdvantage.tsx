      ...
      <div className="home-container">
        <div className="grid gap-4 lg:grid-cols-[0.88fr_1.12fr] lg:items-stretch">
          <div className="relative overflow-hidden bg-[#242124] px-6 py-8 shadow-[0_28px_95px_rgba(0,0,0,0.32)] md:px-8 md:py-10 lg:px-10 lg:py-11">
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_10%_0%,rgba(194,161,57,0.14),transparent_34%),linear-gradient(135deg,rgba(245,240,232,0.055),transparent_42%)]" />
          ...
          <div className="grid gap-3">
            {points.map((point, index) => (
              <article
                key={point}
                className="investment-point-card group relative min-h-[128px] overflow-hidden border border-[#F5F0E8]/10 bg-[#242124]/82 p-5 shadow-[0_22px_75px_rgba(0,0,0,0.26)] backdrop-blur-[5px] transition-all duration-500 hover:-translate-y-0.5 hover:border-[#C2A139]/45 hover:bg-[#242124]/94 md:p-6 lg:min-h-[138px]"
              >
