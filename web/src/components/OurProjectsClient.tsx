        ...
        {visibleProjects.map((project, index) => {
          ...
          return (
            ...
            >
              ...
              />
              <div className={`absolute inset-0 transition duration-500 ${isActive ? "bg-gradient-to-t from-[#05070B]/94 via-[#05070B]/50 to-[#05070B]/24" : "bg-[#05070B]/78"}`} />
              <div className="absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-[#05070B]/68 via-[#05070B]/28 to-transparent" />
      ...
      <div className="grid gap-3 p-3 lg:hidden">
        {visibleProjects.map((project, index) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#05070B]/94 via-[#05070B]/52 to-[#05070B]/22" />
            <div className="absolute inset-x-0 top-0 h-36 bg-gradient-to-b from-[#05070B]/66 to-transparent" />
            <div className="absolute inset-x-0 bottom-0 h-[72%] bg-gradient-to-t from-[#05070B]/98 via-[#05070B]/82 to-transparent" />
